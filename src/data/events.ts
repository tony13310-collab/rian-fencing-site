...
export const allEvents: CompEvent[] = [
  ...
  ...s("2024-2025", [
    ...
    { date: "2025-03-15", tournament: "Capital Czajkowski Cup #3", event: "Senior Mixed Saber", category: "Senior", level: "Local", place: 3, total: 27, rating: "B25", ftlEventId: "759D718E5B0149278533708A882F85CC" },
    ...
    { date: "2025-01-05", tournament: "January NAC", event: "Cadet Men's Saber", category: "Cadet", level: "National", place: 93, total: 131, rating: "", ftlEventId: "30DC03F1471444FFB8B16F849A8FC115" },
    ...
    { date: "2024-10-12", tournament: "Ben Gutenberg SYC", event: "Y-14 Men's Saber", category: "Y-14", level: "SYC", place: 10, total: 93, rating: "", ftlEventId: "650757ADB12E47BABD7410CD1089770A" },
    { date: "2024-09-21", tournament: "River City Regional Rumble", event: "Cadet Men's Saber", category: "Cadet", level: "RYC", place: 17, total: 39, rating: "", ftlEventId: "BC402D1D74C04870B43366C799EA97F5" },
  ]),
  ...
  ...s("2023-2024", [
    ...
    { date: "2024-05-05", tournament: "Mission SYC", event: "Y-12 Men's Saber", category: "Y-12", level: "SYC", place: 3, total: 75, rating: "", ftlEventId: "3D287685D105411D9A4851D5B515D1E1" },
    { date: "2024-05-04", tournament: "Mission SYC", event: "Y-14 Men's Saber", category: "Y-14", level: "SYC", place: 8, total: 103, rating: "", ftlEventId: "FF85124947E44714B4820FCE033882BA" },
    { date: "2024-04-21", tournament: "NoVA Knights RYC/RJCC", event: "Cadet Men's Saber", category: "Cadet", level: "RYC", place: 1, total: 23, rating: "D24", medal: "🥇", ftlEventId: "F0C46479E1694153A55910EF61F1FD94" },
    { date: "2024-04-20", tournament: "NoVA Knights RYC/RJCC", event: "Y-14 Men's Saber", category: "Y-14", level: "RYC", place: 17, total: 41, rating: "", ftlEventId: "751EF4090EB8438CB23D3B8E21724C93" },
    ...
    { date: "2023-09-24", tournament: "River City Regional Rumble", event: "Y-14 Men's Saber", category: "Y-14", level: "RYC", place: 2, total: 31, rating: "", ftlEventId: "513197BC5DA14131A59268E3CDE10504" },
    { date: "2023-09-23", tournament: "River City Regional Rumble", event: "Cadet Men's Saber", category: "Cadet", level: "RYC", place: 16, total: 33, rating: "", ftlEventId: "BA9D77BCC1B747D89A94E1F4B0B9F04C" },
    { date: "2023-09-03", tournament: "North Texas Roundup SYC/RCC", event: "Y-14 Men's Saber", category: "Y-14", level: "SYC", place: 8, total: 67, rating: "E23", ftlEventId: "28D3EFA607444D388240F8D12C2E2EA0" },
    { date: "2023-09-02", tournament: "North Texas Roundup SYC/RCC", event: "Y-12 Men's Saber", category: "Y-12", level: "SYC", place: 11, total: 47, rating: "", ftlEventId: "AA6633133971432A9B424BE223837826" },
  ]),
  ...
  ...s("2022-2023", [
    ...
    { date: "2023-04-16", tournament: "Fairfax Challenge Spring RYC/RJCC", event: "Y-12 Men's Saber", category: "Y-12", level: "RYC", place: 10, total: 38, rating: "", ftlEventId: "2C1F0C8FB16A42918B5875320179EE79" },
    { date: "2023-03-11", tournament: "Ben Gutenberg Memorial SYC/RCC", event: "Y-12 Men's Saber", category: "Y-12", level: "SYC", place: 10, total: 54, rating: "", ftlEventId: "535EAF44411B4BF0BAD08856CCEE6247" },
    ...
    { date: "2023-02-11", tournament: "River City Regional Rumble", event: "Y-12 Men's Saber", category: "Y-12", level: "RYC", place: 7, total: 28, rating: "", ftlEventId: "A2BB3645EEF24D6F9E0533E4464132A0" },
    { date: "2023-01-14", tournament: "Capitol Clash SYC/RCC", event: "Y-12 Men's Saber", category: "Y-12", level: "SYC", place: 71, total: 122, rating: "", ftlEventId: "061892C0F5834FD48B1BD379322F2D11" },
    ...
    { date: "2022-10-02", tournament: "NoVA Knights RYC/RJCC", event: "Y-12 Men's Saber", category: "Y-12", level: "RYC", place: 3, total: 30, rating: "", ftlEventId: "84464C88567B49909C1D00E39F44BC37" },
    { date: "2022-10-01", tournament: "NoVA Knights RYC/RJCC", event: "Y-14 Men's Saber", category: "Y-14", level: "RYC", place: 10, total: 17, rating: "", ftlEventId: "AFFFCF9751284E6B94657B16A2B73726" },
    ...
    { date: "2022-09-03", tournament: "North Texas Roundup SYC/RCC", event: "Y-12 Men's Saber", category: "Y-12", level: "SYC", place: 37, total: 53, rating: "", ftlEventId: "9C6992F58C324E00BCC1B8DB862CBEDC" },
  ]),

  // === 2021-2022 Season ===
  ...s("2021-2022", [
    { date: "2022-07-11", tournament: "Summer Nationals", event: "Y-10 Men's Saber", category: "Y-10", level: "National", place: 12, total: 96, rating: "", ftlEventId: "8670A43A92974A23A32FEFA63B2B1E94" },
    { date: "2022-06-12", tournament: "DCFC Youth Challenge", event: "Y-10 Mixed Saber", category: "Y-10", level: "Local", place: 1, total: 10, rating: "", medal: "🥇", ftlEventId: "A09BE9EE91C047D2A7554D0A3F0A9493" },
    ...
    { date: "2021-06-19", tournament: "Fairfax Challenge Summer", event: "Y-10 Men's Saber", category: "Y-10", level: "RYC", place: 6, total: 13, rating: "", ftlEventId: "0DE9BF8AF97B4FA291397D8AEE36498C" },
